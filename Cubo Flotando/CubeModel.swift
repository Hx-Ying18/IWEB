...
class CubeModel {
    ...
    private var g = 9.8
    var w = sqrt((2*9.8)/50.0) // It is found when neccesary.
    //   private var A = 1.0
    ...
    // These methods must be public so it can be acceced to them from the viewCOntroller
    /**
